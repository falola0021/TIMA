...
function Table () {
  ...
  const columns = ['Pick-Up Address', 'Drop-Off Address', 'Item', 'Amount', 'Delivery Schedule', 'Status', 'Details']

  const data = [
    ['Gabby George', 'Business Analyst', 'Minneapolis', 30, '$100,000', 'Status',
      <button onClick={handleDeatails} className={Style.details}>
        View Details
      </button>

    ],
    ['Aiden Lloyd', 'Business Consultant', 'Dallas', 55, '$200,000', 'Status',
      <button onClick={handleDeatails} className={Style.details}>
        View Details
      </button>
    ],
    ['Jaden Collins', 'Attorney', 'Santa Ana', 27, '$500,000', 'Status',
      <button onClick={handleDeatails} className={Style.details}>
        View Details
      </button>
    ],
    ['Franky Rees', 'Business Analyst', 'St. Petersburg', 22, '$50,000', 'Status',
      <button onClick={handleDeatails} className={Style.details}>
        View Details
      </button>
    ],

    ['Frankie Parry', 'Agency Legal Counsel', 'Jacksonville', 71, '$210,000', 'Status',
      <button onClick={handleDeatails} className={Style.details}>
        View Details
      </button>
    ],
    ['Lane Wilson', 'Commercial Specialist', 'Omaha', 19, '$65,000', 'Status',
      <button onClick={handleDeatails} className={Style.details}>
        View Details
      </button>
    ]
